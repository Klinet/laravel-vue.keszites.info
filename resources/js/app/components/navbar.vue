                ...
                <div class="container">
                    <div class="d-flex align-items-center">
                        ...
                        <ul class="nav-menu nav navbar-nav" v-if="!app.user">
                            ...
                            <li class="cat-2"><a @click="clickCateg(1)">JavaScript</a></li>
                            <li class="cat-3"><a @click="clickCateg(2)">Css</a></li>
                            <li class="cat-3"><a @click="clickCateg(3)">Jquery</a></li>
                        </ul>
